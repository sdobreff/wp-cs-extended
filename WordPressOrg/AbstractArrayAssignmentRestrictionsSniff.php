...
namespace WordPressCS\WordPressOrg;
 ...
 *                 `\WordPressCS\WordPressOrg\Sniffs\Arrays\ArrayAssignmentRestrictionsSniff` to
 *                 `\WordPressCS\WordPressOrg\AbstractArrayAssignmentRestrictionsSniff`.
 */
