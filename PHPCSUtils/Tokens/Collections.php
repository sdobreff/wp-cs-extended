...
defined('T_READONLY') || define ('T_READONLY', 'T_READONLY');
defined('T_ENUM') || define ('T_ENUM', 'T_ENUM');
defined('T_TYPE_INTERSECTION') || define ('T_TYPE_INTERSECTION', 'T_TYPE_INTERSECTION');
